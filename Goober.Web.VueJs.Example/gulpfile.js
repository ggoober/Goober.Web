...
/**  ================================================================================
  ...
  *
  *  Если ты читаешь эту надпись, то знай, что **ВСЕ**, что тебе, скорее всего, необходимо, можно сделать в `package.json` и `.gulprc`
  ...
  *  
  *  Но на крайняк, можно в файле `.gulpsrc` прописать алиас для библиотеки в формате:
  *  ```json:
  *  <...>
  *      "aliases": {
  ...
  *  Если необходимо добавить css-файл в `vendor.css`, его ОБЯЗАТЕЛЬНО нужно вписать в `.gulprc`:
  *  ```json
  *  <...>
  *      "vendorCss": [
  ...
  *  Если речь идет о модулях для Vue.js - рекомендую использовать [компоненты]
